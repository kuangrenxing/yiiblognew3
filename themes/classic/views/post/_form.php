...
<div class="row">
    <?php echo CHtml::activeLabel($model,'title_en'); ?>
    <?php echo CHtml::activeTextField($model,'title',array('size'=>60,'maxlength'=>128,'id'=>'title')); ?>
</div>
<div class="row">
    <?php echo CHtml::activeLabel($model,'title_cn'); ?>
    <?php echo CHtml::activeTextField($model,'title2',array('size'=>60,'maxlength'=>128,'id'=>'title')); ?>
</div>
...
<div class="row">
    <?php echo CHtml::activeLabel($model,'content_en'); ?>
    <?php echo CHtml::activeTextArea($model,'content',array('rows'=>6, 'cols'=>70,'id'=>'go')); ?>
</div>
<div class="row">
    <?php echo CHtml::activeLabel($model,'content_cn'); ?>
    <?php echo CHtml::activeTextArea($model,'content2',array('rows'=>6, 'cols'=>70,'id'=>'go')); ?>
</div>
<div class="row">
...
//editor2 = CKEDITOR.replace('Post[content2]');
/*]]>*/
</script>
